...
// @Description Get a list of sections with pagination. All authenticated users can access this endpoint.
// @Tags sections
// @Accept json
// @Produce json
// @Security BearerAuth
...
// @Success 200 {object} common.Response{data=[]model.Section,meta=common.Paging} "Success"
...
func ListSection(appCtx appctx.AppContext) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		result, err := business.ListSection(c.Request.Context(), &paging)
		if err != nil {
			panic(err)
		}
